...
def main_app():
    ...
    # Tabs: Gestión primero para que al hacer st.rerun() permanezca en esta pestaña
        ...
        if not numero_activo:
            ...
            if submit:
                ...
                try:
                    ...
                    st.success("✅ Cambios guardados. (Permaneces en Gestión)")
                    # Limpiar formulario: borrar la factura activa y seguir en Gestión
